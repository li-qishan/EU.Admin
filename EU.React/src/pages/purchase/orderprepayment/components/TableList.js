...
let moduleCode = "PO_ORDER_PREPAYMENT_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'poprepayment/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, poprepayment: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'poprepayment/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
