...
let moduleCode = "PO_REQUESTION_DETAIL_REPORT_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'porequestiondetailreport/getModuleInfo',
            payload: { moduleCode },
        })
    }
    async onConfirmIn() {
    ...
    render() {
        const { dispatch, porequestiondetailreport: { moduleInfo, tableParam } } = this.props;
