...
let moduleCode = "PO_DEDUCTION_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'podeductiondetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        const { dispatch, podeductiondetail: { moduleInfo, tableParam }, IsView, returnme } = this.props;
            ...
            <div>
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'podeductiondetail/batchSaveData',
                            payload: values,
                        }).then(() => {
                            const { podeductiondetail: { Id } } = me.props;
                ...
                <FormEdit
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'podeductiondetail/saveData',
                            payload: values,
                        }).then(() => {
                            const { podeductiondetail: { Id } } = me.props;
                            this.setState({ DetailId: Id })
