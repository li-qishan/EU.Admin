...
let moduleCode = "PO_UN_ARRIVAL_ANALYSIS_REPORT_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pounarrivalanalysisreport/getModuleInfo',
            payload: { moduleCode },
        })
    }
    async onConfirmIn() {
    ...
    render() {
        const { dispatch, pounarrivalanalysisreport: { moduleInfo, tableParam } } = this.props;
