...
class FormPage extends Component {
    ...
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, poorderdetail: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
            ...
            >
                ...
                >
                    <Row gutter={24} justify={"center"}>
                        <Col span={12}>
                            <FormItem name="PurchaseQTY" label="数量" rules={[{
                                required: true
                            }, {
                                type: 'number', min: 1, message: '数量最小值为1 !'
                            }]}>
                        ...
                        <Col span={12}>
                            <FormItem name="Price" label="单价" rules={[{
                                ...
                                type: 'number', min: 0, message: '单价最小值为0 !'
                            }]}>
                                <InputNumber placeholder="请输入" disabled={IsView} />
                            </FormItem>
                        </Col>
