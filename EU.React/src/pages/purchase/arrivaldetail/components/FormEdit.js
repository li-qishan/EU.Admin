...
import { Modal, DatePicker, Form, Row, Col, InputNumber } from 'antd';
...
class FormPage extends Component {
    ...
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, poarrivaldetail: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
            ...
            >
                ...
                >
                    <Row gutter={24} justify={"center"}>
                        <Col span={12}>
                            <FormItem name="ArrivalQTY" label="到货数量" rules={[{
                                required: true
                            }, {
                                type: 'number', min: 1, message: '到货数量最小值为1 !'
                            }]}>
