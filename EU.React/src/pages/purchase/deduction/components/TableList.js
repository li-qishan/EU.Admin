...
let moduleCode = "PO_DEDUCTION_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'podeductionorder/getModuleInfo',
            payload: { moduleCode }
        })
    }
    render() {
        const { dispatch, podeductionorder: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'podeductionorder/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ podeductionorder }) => ({
    podeductionorder,
