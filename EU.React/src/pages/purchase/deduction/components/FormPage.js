...
import DetailTable from '../../deductiondetail/components/TableList';
...
class FormPage extends Component {
        ...
        if (dispatch && Id) {
            ...
            dispatch({
                ...
                if (data && me.formRef.current) {
                    ...
                    dispatch({
                        type: 'podeductionorder/setDetail',
                        payload: data
                    });
    ...
    onFinish(values) {
        ...
        dispatch({
            type: 'podeductionorder/saveData',
            payload: values,
        }).then(() => {
            const { podeductionorder: { Id } } = me.props;
            if (Id)
...
export default connect(({ podeductionorder, user }) => ({
    podeductionorder, user
