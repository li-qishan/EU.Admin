...
import { GetByCode } from '../../system/setup/paramconfig/service';
...
const Model = {
    ...
    effects: {
        ...
        *getConfigByCode({ payload }, { call, put }) {
            const response = yield call(GetByCode, payload);
            yield put({
                type: 'getConfigByCodeSuccess',
                payload: response
            });
        }
    },
    reducers: {
        ...
        getConfigByCodeSuccess(state, { payload }) {
            return { ...state, isPOArrival: payload.value };
        },
    },
};
