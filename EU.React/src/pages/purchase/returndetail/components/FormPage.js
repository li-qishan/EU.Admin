...
import { queryWaitReturn } from '../service';
...
class FormPage extends Component {
    ...
    render() {
        ...
        let columns = [{
            ...
            title: Source == 'InOrder' ? '入库数量' : '到货数量',
            dataIndex: 'QTY',
            valueType: 'digit'
        }, {
            title:'退库剩余数量',
            dataIndex: 'MaxReturnQTY',
            valueType: 'digit'
        }];
        ...
        hasColumns.push({
            ...
            render: (text, record) => (
                <InputNumber
                    ...
                    onChange={(value) => me.onCommonChange(value, record, 'ReturnQTY')}
                />
            )
                        ...
                        <ProTable
                            ...
                            toolBarRender={() => [
                                ...
                                >
                                    ...
                                    <Select.Option value="ArrivalOrder">到货通知单</Select.Option>
                                </Select>
                            ]}
                        />
                    </TabPane>
