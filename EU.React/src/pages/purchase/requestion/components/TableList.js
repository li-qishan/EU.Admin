...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'requestion/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, requestion: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'requestion/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ requestion }) => ({
    requestion,
