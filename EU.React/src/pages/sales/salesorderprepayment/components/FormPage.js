...
class FormPage extends Component {
    ...
    onSubmitSuccess() {
        ...
        me.formRef.current.resetFields();
        dispatch({
            type: 'salesorderprepayment/setId',
            payload: ''
            // }).then(() => {
    ...
    //     }
    //     dispatch({
    //         type: 'salesorderprepayment/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, salesorderprepayment: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
        const { modalVisible, IsView, onCancel, salesorderprepayment: { Id } } = this.props;
