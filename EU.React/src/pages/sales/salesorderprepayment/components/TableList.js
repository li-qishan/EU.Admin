...
let moduleCode = "SD_SALES_ORDER_PREPAYMENT_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'salesorderprepayment/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, salesorderprepayment: { moduleInfo, tableParam }, IsView } = this.props;
