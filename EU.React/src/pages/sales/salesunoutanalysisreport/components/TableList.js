...
let moduleCode = "SD_SALES_NO_OUT_ANALYSIS_REPORT_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'sdsalesunoutanalysisreport/getModuleInfo',
            payload: { moduleCode },
        })
    }
    async onConfirmIn() {
    ...
    render() {
        const { dispatch, sdsalesunoutanalysisreport: { moduleInfo, tableParam } } = this.props;
