...
let moduleCode = "SD_OUT_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'outorderdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        const { dispatch, outorderdetail: { moduleInfo, tableParam }, IsView, outdetailme } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'outorderdetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'outorderdetail/batchSaveData',
                            payload: values,
                        }).then(() => {
                            setTimeout(filehide);
                            const { outorderdetail: { Id } } = me.props;
