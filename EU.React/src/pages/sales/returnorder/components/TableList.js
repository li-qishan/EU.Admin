...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'returnorder/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, returnorder: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'returnorder/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ returnorder }) => ({
    returnorder,
