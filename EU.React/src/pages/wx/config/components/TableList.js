...
let moduleCode = "SM_WX_CONFIG_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'wxconfig/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, wxconfig: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ wxconfig }) => ({
    wxconfig,
