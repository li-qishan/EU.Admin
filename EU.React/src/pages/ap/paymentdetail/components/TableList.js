...
let moduleCode = "AP_PAYMENT_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'appaymentdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, appaymentdetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'appaymentdetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
