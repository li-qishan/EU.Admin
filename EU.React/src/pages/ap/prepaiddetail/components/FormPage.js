        ...
        hasColumns.push({
            ...
            render: (text, record) => (
                <ComBoBox
                    ...
                    placeholder="请输入"
                    size='small'
                    value={text} onChange={(value) => me.onCommonChange(value, record, 'PaymentType')} />
            )
        }, {
            title: '付款金额',
            ...
            render: (text, record) => (
                <InputNumber
                    ...
                    value={text}
                    min='0'
                    max={record.MaxPaymentAmount}
                    onChange={(value) => me.onCommonChange(value, record, 'PaymentAmount')}
                />
            )
        }, {
            title: '银行名称',
