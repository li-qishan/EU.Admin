...
let moduleCode = "AP_PREPAID_ORDER_DETAIL_MNG";
let me;
...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'apprepaiddetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        const { dispatch, apprepaiddetail: { moduleInfo, tableParam }, IsView } = this.props;
            ...
            <div>
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'apprepaiddetail/batchSaveData',
                            payload: values,
                        }).then(() => {
                ...
                <FormEdit
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            ...
                            const { apprepaiddetail: { Id } } = me.props;
                            this.setState({ DetailId: Id })
                            if (me.detailActionRef.current) {
                                me.detailActionRef.current.reload();
                            }
