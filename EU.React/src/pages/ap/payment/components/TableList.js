...
let moduleCode = "AP_PAYMENT_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'appayment/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, appayment: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ appayment }) => ({
    appayment,
