...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'apinvoicedetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        const { dispatch, apinvoicedetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'apinvoicedetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'apinvoicedetail/batchSaveData',
                            payload: values,
                        }).then(() => {
                            const { apinvoicedetail: { Id } } = me.props;
...
export default connect(({ apinvoicedetail }) => ({
    apinvoicedetail
