...
let moduleCode = "AP_INVOICE_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'apinvoice/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, apinvoice: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ apinvoice }) => ({
    apinvoice,
