...
class FormPage extends Component {
    ...
    onFinish(values) {
        ...
        dispatch({
            type: 'apinvoice/saveData',
            payload: values,
        }).then((result) => {
            const { apinvoice: { Id } } = me.props;
            if (Id)
                ...
                {this.state.isLoading ? <Card>
                    ...
                    <Card>
                        <Row gutter={24} justify={"center"}>
                            ...
                            <Col span={8}>
                                <FormItem name="ApInvoiceOrderType" label="单据类型" rules={[{ required: true }]}>
                        ...
                        <Row gutter={24} justify={"center"}>
                            ...
                            <Col span={8}>
                                <FormItem name="PayTime" label="付款时间">
...
export default connect(({ apinvoice, user }) => ({
    apinvoice, user
}))(FormPage);
