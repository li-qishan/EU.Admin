...
let moduleCode = "AP_PREPAID_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'apprepaid/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, apprepaid: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ apprepaid }) => ({
    apprepaid,
