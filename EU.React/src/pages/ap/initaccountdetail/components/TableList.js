...
let moduleCode = "AP_INIT_ACCOUNT_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'apinitaccountdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, apinitaccountdetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'apinitaccountdetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ apinitaccountdetail }) => ({
    apinitaccountdetail
