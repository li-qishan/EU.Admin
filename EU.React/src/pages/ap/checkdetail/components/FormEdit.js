...
class FormPage extends Component {
            ...
            if (dispatch && Id && modalVisible) {
                dispatch({
                    ...
                    if (result.Success && me.formRef.current) {
                        me.formRef.current.setFieldsValue(result.Data.data);
                        me.setState({ MaxCheckQTY: result.Data.extend.MaxCheckQTY })
                    }
                })
            }
        }
    ...
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, apcheckdetail: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
