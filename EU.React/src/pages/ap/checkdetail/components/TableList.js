...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'apcheckdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        const { dispatch, apcheckdetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'apcheckdetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'apcheckdetail/batchSaveData',
                            payload: values,
                        }).then(() => {
                            const { apcheckdetail: { Id } } = me.props;
...
export default connect(({ apcheckdetail }) => ({
    apcheckdetail
