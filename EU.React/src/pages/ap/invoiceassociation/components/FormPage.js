...
class FormPage extends Component {
    ...
    onSubmitSuccess() {
        ...
        me.formRef.current.resetFields();
        dispatch({
            type: 'apinvoiceassociation/setId',
            payload: ''
            // }).then(() => {
    ...
    //     }
    //     dispatch({
    //         type: 'apinvoiceassociation/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, apinvoiceassociation: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
        const { modalVisible, IsView, onCancel, apinvoiceassociation: { Id } } = this.props;
