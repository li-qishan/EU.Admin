...
let moduleCode = "AP_INVOICE_ASSOCIATION_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'apinvoiceassociation/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, apinvoiceassociation: { moduleInfo, tableParam }, IsView } = this.props;
