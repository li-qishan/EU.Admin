...
let moduleCode = "AP_PAYMENT_WRITE_OFF_MNG";
let me;
const { confirm } = Modal;
...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'appaymentwriteoff/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        const { dispatch, appaymentwriteoff: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'appaymentwriteoff/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'appaymentwriteoff/batchSaveData',
                            payload: values,
                        }).then(() => {
                            const { appaymentwriteoff: { Id } } = me.props;
                ...
                <FormEdit
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'appaymentwriteoff/saveData',
                            payload: values,
                        }).then(() => {
                            const { appaymentwriteoff: { Id } } = me.props;
                            this.setState({ DetailId: Id })
...
export default connect(({ appaymentwriteoff }) => ({
    appaymentwriteoff
