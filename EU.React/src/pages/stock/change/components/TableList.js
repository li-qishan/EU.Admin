...
let moduleCode = "IV_STOCK_QTY_CHANGE_MNG";
let me;
let modelName = 'ivqtychange';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, ivqtychange: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    // onReset={() => {
                    //     dispatch({
                    //         type: 'ivqtychange/setTableStatus',
                    //         payload: {},
                    //     })
                    // }}
                    onLoad={() => {
...
export default connect(({ ivqtychange }) => ({
    ivqtychange,
