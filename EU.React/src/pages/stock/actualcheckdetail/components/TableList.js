...
let moduleCode = "IV_STOCK_ACTUAL_CHECK_DETAIL_MNG";
let me;
let modelName = 'ivactualcheckdetail';
...
class TableList extends Component {
    ...
    // }
    render() {
        let { dispatch, ivactualcheckdetail: { moduleInfo, tableParam }, IsView } = this.props;
        const { masterId, detailVisible, detailView, editVisible } = this.state;
