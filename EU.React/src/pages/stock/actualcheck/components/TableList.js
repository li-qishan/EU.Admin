...
let moduleCode = "IV_STOCK_ACTUAL_CHECK_MNG";
let me;
let modelName = 'ivactualcheck';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, ivactualcheck: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    // onReset={() => {
                    //     dispatch({
                    //         type: 'ivactualcheck/setTableStatus',
                    //         payload: {},
                    //     })
                    // }}
                    onLoad={() => {
...
export default connect(({ ivactualcheck }) => ({
    ivactualcheck,
