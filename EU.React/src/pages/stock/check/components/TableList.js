...
let moduleCode = "IV_STOCK_CHECK_MNG";
let me;
let modelName = 'ivcheck';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, ivcheck: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ ivcheck }) => ({
    ivcheck,
