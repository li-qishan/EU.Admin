...
let moduleCode = "IV_STOCK_ADJUST_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'ivadjustdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        let { dispatch, ivadjustdetail: { moduleInfo, tableParam }, IsView } = this.props;
        const { masterId, detailVisible, editVisible, detailView } = this.state;
        moduleInfo.modelName = 'ivadjustdetail';
            ...
            <div>
                <SmProTable
                    ...
                    request={(params, sorter, filter) => {
                        ...
                        dispatch({
                            type: 'ivadjustdetail/setTableStatus',
                ...
                <DetailForm
                    ...
                    onSubmit={async (values, calback) => {
                        ...
                        dispatch({
                            type: 'ivadjustdetail/batchSaveData',
                            payload: values,
                        }).then((result) => {
