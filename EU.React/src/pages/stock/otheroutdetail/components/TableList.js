...
let moduleCode = "IV_STOCK_OTHER_OUT_DETAIL_MNG";
let me;
let modelName = 'ivotheroutdetail';
...
class TableList extends Component {
    ...
    // }
    render() {
        let { dispatch, ivotheroutdetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                ...
                <DetailForm
                    ...
                    onSubmit={async (values, calback) => {
                        ...
                        dispatch({
                            ...
                            if (result && result.status === "ok") {
                                ...
                                me.setState({ detailVisible: false });
                    ...
                    onCancel={() => { me.setState({ detailVisible: false }) }}
                />
                <FormEdit
