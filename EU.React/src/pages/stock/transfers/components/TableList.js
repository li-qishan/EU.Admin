...
let moduleCode = "IV_STOCK_TRANSFERS_MNG";
let me;
let modelName = 'ivtransfers';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, ivtransfers: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ ivtransfers }) => ({
    ivtransfers,
