...
let moduleCode = "IV_STOCK_ADJUST_MNG";
let me;
let modelName = 'ivadjust';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, ivadjust: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ ivadjust }) => ({
    ivadjust,
