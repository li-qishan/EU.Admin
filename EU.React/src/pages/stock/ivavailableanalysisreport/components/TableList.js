...
let moduleCode = "IV_AVAILABLE_INVENTORY_ANALYSIS_REPORT_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'ivavailableanalysisreport/getModuleInfo',
            payload: { moduleCode },
        })
    }
    async onConfirmIn() {
    ...
    render() {
        const { dispatch, ivavailableanalysisreport: { moduleInfo, tableParam } } = this.props;
