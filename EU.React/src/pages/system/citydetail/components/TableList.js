...
let moduleCode = "SM_CITY_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    render() {
        const { dispatch, citydetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'citydetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                    ...
                    request={(params, sorter, filter) => {
                        ...
                        filter.CityId = masterId;
                        if (masterId)
                            return query({
                                paramData: JSON.stringify(params),
                                sorter: JSON.stringify(sorter),
                                filter: JSON.stringify(filter),
                                moduleCode, CityId: masterId
                            })
                    }}
                />
                <DetailForm
