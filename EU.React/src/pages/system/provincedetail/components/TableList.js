...
let moduleCode = "SM_PROVINCE_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'provincedetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, provincedetail: { moduleInfo, tableParam }, IsView } = this.props;
            ...
            <div>
                <SmProTable
                    ...
                    request={(params, sorter, filter) => {
                        ...
                        filter.ProvinceId = masterId;
                        if (masterId)
                            return query({
                                paramData: JSON.stringify(params),
                                sorter: JSON.stringify(sorter),
                                filter: JSON.stringify(filter),
                                moduleCode, ProvinceId: masterId
                            })
                    }}
                />
                <DetailForm
