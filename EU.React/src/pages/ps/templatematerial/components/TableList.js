...
let moduleCode = "PS_PROCESS_TEMPLATE_MATERIAL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pstemplatematerial/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pstemplatematerial: { moduleInfo, tableParam }, IsView } = this.props;
