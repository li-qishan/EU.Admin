...
let moduleCode = "PS_PROCESS_BAD_REASON_MNG";
let me;
let modelName = 'processreason';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, processreason: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    // onReset={() => {
                    //     dispatch({
                    //         type: 'processreason/setTableStatus',
                    //         payload: {},
                    //     })
                    // }}
                    onLoad={() => {
