...
let moduleCode = "PS_PROCESS_TEMPLATE_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pstemplatedetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pstemplatedetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pstemplatedetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                    ...
                    request={(params, sorter, filter) => {
                        ...
                        filter.TemplateId = masterId;
                        if (masterId)
                            return query({
                                paramData: JSON.stringify(params),
                                sorter: JSON.stringify(sorter),
                                filter: JSON.stringify(filter),
                                moduleCode, TemplateId: masterId
                            })
                    }}
                />
                <DetailForm
