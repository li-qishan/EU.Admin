...
let moduleCode = "PS_PROCESS_EMPLOYEE_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'processemployee/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, processemployee: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'processemployee/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
