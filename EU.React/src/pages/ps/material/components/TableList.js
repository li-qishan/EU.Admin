...
let moduleCode = "PS_PROCESS_BOM_MATERIAL_MNG";
let me;
class TableList extends Component {
    ...
    // }
    render() {
        const { dispatch, psmaterial: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'psmaterial/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
