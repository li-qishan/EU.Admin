...
let moduleCode = "AR_SALES_COLLECTION_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'arcollectiondetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, arcollectiondetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'arcollectiondetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
