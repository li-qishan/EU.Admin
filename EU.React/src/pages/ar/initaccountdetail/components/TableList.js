...
let moduleCode = "AR_INIT_ACCOUNT_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'arinitaccountdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, arinitaccountdetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'arinitaccountdetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ arinitaccountdetail }) => ({
    arinitaccountdetail
