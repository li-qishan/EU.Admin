...
let moduleCode = "AR_CHECK_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'archeck/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, archeck: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ archeck }) => ({
    archeck,
