...
import { query, Delete } from '../service';
...
let moduleCode = "AR_PREPAID_ORDER_DETAIL_MNG";
let me;
...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'arprepaiddetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    // }
    render() {
        const { dispatch, arprepaiddetail: { moduleInfo, tableParam }, IsView } = this.props;
            ...
            <div>
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            type: 'arprepaiddetail/batchSaveData',
                            payload: values,
                        }).then(() => {
                ...
                <FormEdit
                    ...
                    onSubmit={async values => {
                        ...
                        dispatch({
                            ...
                            const { arprepaiddetail: { Id } } = me.props;
                            this.setState({ DetailId: Id })
                            if (me.detailActionRef.current) {
                                me.detailActionRef.current.reload();
                            }
