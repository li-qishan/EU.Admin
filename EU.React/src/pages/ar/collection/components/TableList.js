...
let moduleCode = "AR_SALES_COLLECTION_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'arcollection/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, arcollection: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'arcollection/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ arcollection }) => ({
    arcollection,
