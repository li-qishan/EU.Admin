...
let moduleCode = "AR_INIT_ACCOUNT_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'arinitaccount/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, arinitaccount: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'arinitaccount/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ arinitaccount }) => ({
    arinitaccount,
