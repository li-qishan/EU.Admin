...
let moduleCode = "AR_INVOICE_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'arinvoice/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, arinvoice: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ arinvoice }) => ({
    arinvoice,
