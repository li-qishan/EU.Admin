...
let moduleCode = "SM_IMPORT_TEMPLATE_DETAIL_MNG";
let me;
let modelName = 'importconfigdetail';
...
class TableList extends Component {
    ...
    // }
    render() {
        let { dispatch, importconfigdetail: { moduleInfo, tableParam }, IsView } = this.props;
            ...
            <div>
                <SmProTable
                    ...
                    request={(params, sorter, filter) => {
                        ...
                        params.ImpTemplateId = masterId;
                        return query({
                            paramData: JSON.stringify(params),
                            sorter: JSON.stringify(sorter),
                            filter: JSON.stringify(filter),
                            moduleCode,
                            ImpTemplateId: masterId
                        })
                    }}
                    search={false}
                ...
                <DetailForm
                    ...
                    onSubmit={async values => {
                        ...
                        // }
                        if (masterId) {
                            values.ImpTemplateId = masterId;
                        }
                        dispatch({
                            type: 'importconfigdetail/saveData',
                            payload: values,
                        }).then(() => {
                            const { importconfigdetail: { Id } } = me.props;
