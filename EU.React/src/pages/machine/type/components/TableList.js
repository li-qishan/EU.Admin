...
let moduleCode = "EM_MACHIN_TYPE_MNG";
let me;
let modelName = 'machinetype';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, machinetype: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    // onReset={() => {
                    //     dispatch({
                    //         type: 'machinetype/setTableStatus',
                    //         payload: {},
                    //     })
                    // }}
                    onLoad={() => {
...
export default connect(({ machinetype }) => ({
    machinetype,
