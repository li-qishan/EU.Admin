...
let moduleCode = "BD_CUSTOMER_DELIVERY_ADDRESS_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'customerdeliveryaddress/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, customerdeliveryaddress: { moduleInfo, tableParam }, IsView } = this.props;
