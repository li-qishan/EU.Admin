...
class FormPage extends Component {
    ...
    //     }
    //     dispatch({
    //         type: 'currency/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { currency: { Id } } = me.props;
    //         if (Id)
    //             this.setState({ Id })
    //     });
    // }
            ...
            >
                ...
                {isLoading ? <Card>
                    ...
                    <Row gutter={24} justify={"center"}>
                        <Col span={12}>
                            <FormItem name="CurrencyNo" label="币别编号" rules={[{ required: true }]}>
                                <Input placeholder="请输入" disabled={IsView} />
                            </FormItem>
                        </Col>
                        <Col span={12}>
                            <FormItem name="CurrencyName" label="币别名称" rules={[{ required: true }]}>
                                <Input placeholder="请输入" disabled={IsView} />
                            </FormItem>
                        </Col>
                    </Row>
