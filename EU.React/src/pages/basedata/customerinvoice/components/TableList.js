...
let moduleCode = "BD_CUSTOMER_INVOICE_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'customerinvoice/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, customerinvoice: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'customerinvoice/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
