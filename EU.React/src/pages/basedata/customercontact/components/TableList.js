...
let moduleCode = "BD_CUSTOMER_CONTACT_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'customercontact/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, customercontact: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'customercontact/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
