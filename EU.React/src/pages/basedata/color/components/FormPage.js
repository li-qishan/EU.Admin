            ...
            >
                ...
                {isLoading ? <Card>
                    ...
                    <Row gutter={24} justify={"center"}>
                        <Col span={12}>
                            <FormItem name="ColorNo" label="颜色编号" rules={[{ required: true }]}>
                                <Input placeholder="请输入" disabled={IsView} />
                            </FormItem>
                        </Col>
                        <Col span={12}>
                            <FormItem name="ColorNames" label="颜色名称" rules={[{ required: true }]}>
                                <Input placeholder="请输入" disabled={IsView} />
                            </FormItem>
                        </Col>
                    </Row>
