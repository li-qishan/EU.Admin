...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'color/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, color: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ color, loading }) => ({
    color,
