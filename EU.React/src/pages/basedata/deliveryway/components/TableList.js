...
let moduleCode = "BD_DELIVERY_WAY_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'deliveryway/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, deliveryway: { moduleInfo, tableParam } } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'deliveryway/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
...
export default connect(({ deliveryway, loading }) => ({
    deliveryway,
