...
let moduleCode = "RM_TYPE_MNG";
let me;
let modelName = 'rmtype';
...
class TableList extends Component {
    ...
    render() {
        let { dispatch, rmtype: { moduleInfo, tableParam } } = this.props;
