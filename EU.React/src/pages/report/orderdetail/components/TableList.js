...
let moduleCode = "RM_FEE_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'rmorderdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, rmorderdetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'rmorderdetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
