...
import DetailTable from '../../completedetail/components/TableList';
...
class FormPage extends Component {
    ...
    onFinish(values) {
        ...
        dispatch({
            type: 'pdcomplete/saveData',
            payload: values,
        }).then((result) => {
            const { pdcomplete: { Id } } = me.props;
            if (Id)
...
export default connect(({ pdcomplete, user }) => ({
    pdcomplete, user
}))(FormPage);
