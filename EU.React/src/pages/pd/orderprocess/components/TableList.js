...
let moduleCode = "PD_ORDER_PROCESS_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdorderprocess/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pdorderprocess: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pdorderprocess/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
