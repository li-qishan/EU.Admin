...
let moduleCode = "PD_ORDER_MATERIALMNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdordermaterial/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pdordermaterial: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pdordermaterial/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
