...
class FormPage extends Component {
    ...
    //     }
    //     dispatch({
    //         type: 'pdordermaterial/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, pdordermaterial: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
        const { modalVisible, IsView, onCancel, pdordermaterial: { Id } } = this.props;
...
export default connect(({ pdordermaterial }) => ({
    pdordermaterial,
