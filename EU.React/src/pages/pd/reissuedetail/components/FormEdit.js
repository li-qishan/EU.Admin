...
class FormPage extends Component {
    ...
    //     }
    //     dispatch({
    //         type: 'pdreissuedetail/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, pdreissuedetail: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
        const { modalVisible, IsView, onCancel, pdreissuedetail: { Id } } = this.props;
            ...
            >
                ...
                >
                    <Row gutter={24} justify={"center"}>
                        ...
                        <Col span={8}>
                            <FormItem name="QTY" label="补发数量" rules={[{ required: true }]}>
...
export default connect(({ pdreissuedetail }) => ({
    pdreissuedetail,
