...
let moduleCode = "PD_REISSUE_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdreissuedetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pdreissuedetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pdreissuedetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async (values, calback) => {
                        ...
                        dispatch({
                            type: 'pdreissuedetail/batchSaveData',
                            payload: values,
                        }).then((result) => {
