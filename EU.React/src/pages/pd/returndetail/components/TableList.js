...
let moduleCode = "PD_RETURN_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdreturndetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pdreturndetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pdreturndetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async (values, calback) => {
                        ...
                        dispatch({
                            type: 'pdreturndetail/batchSaveData',
                            payload: values,
                        }).then((result) => {
