...
let moduleCode = "PD_OUT_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdoutdetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pdoutdetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pdoutdetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async (values, calback) => {
                        ...
                        dispatch({
                            type: 'pdoutdetail/batchSaveData',
                            payload: values,
                        }).then((result) => {
