...
class FormPage extends Component {
    ...
    //     }
    //     dispatch({
    //         type: 'pdoutdetail/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, pdoutdetail: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
        const { modalVisible, IsView, onCancel, pdoutdetail: { Id } } = this.props;
...
export default connect(({ pdoutdetail }) => ({
    pdoutdetail,
