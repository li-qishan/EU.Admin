...
let moduleCode = "PD_REISSUE_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdreissue/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, pdreissue: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ pdreissue }) => ({
    pdreissue,
