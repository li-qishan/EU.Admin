...
import DetailTable from '../../outdetail/components/TableList';
    ...
    async onConfirmOut() {
        ...
        Modal.confirm({
            ...
            async onOk() {
                ...
                let result = await request('/api/PdOutOrder/ConfirmOut', {
                    method: 'POST',
                    params: {
                        Id
                    }
...
export default connect(({ pdout, user }) => ({
    pdout, user
}))(FormPage);
