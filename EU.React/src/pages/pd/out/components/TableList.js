...
let moduleCode = "PD_OUT_ORDER_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdout/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, pdout: { moduleInfo, tableParam } } = this.props;
