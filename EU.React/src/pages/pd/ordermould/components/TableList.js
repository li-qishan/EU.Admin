...
let moduleCode = "PD_ORDER_MOULD_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdordermould/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pdordermould: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pdordermould/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
