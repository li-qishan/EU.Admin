...
class FormPage extends Component {
    ...
    //     }
    //     dispatch({
    //         type: 'pdordermould/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, pdordermould: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
        const { modalVisible, IsView, onCancel, pdordermould: { Id } } = this.props;
...
export default connect(({ pdordermould }) => ({
    pdordermould,
