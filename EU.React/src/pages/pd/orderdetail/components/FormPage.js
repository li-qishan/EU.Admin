...
class FormPage extends Component {
    ...
    //     }
    //     dispatch({
    //         type: 'pdorderdetail/saveData',
    //         payload: values,
    //     }).then(() => {
    //         const { dispatch, pdorderdetail: { Id } } = me.props;
    //         this.setState({ Id })
    //     });
    // }
    render() {
        const { modalVisible, IsView, onCancel, pdorderdetail: { Id } } = this.props;
