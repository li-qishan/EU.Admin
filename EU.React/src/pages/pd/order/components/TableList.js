...
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdorder/getModuleInfo',
            payload: { moduleCode },
        })
    }
    render() {
        const { dispatch, pdorder: { moduleInfo, tableParam } } = this.props;
...
export default connect(({ pdorder }) => ({
    pdorder,
