...
let moduleCode = "PD_COMPLETE_ORDER_DETAIL_MNG";
let me;
class TableList extends Component {
    ...
    componentWillMount() {
        ...
        dispatch({
            type: 'pdcompletedetail/getModuleInfo',
            payload: { moduleCode }
        });
    ...
    render() {
        const { dispatch, pdcompletedetail: { moduleInfo, tableParam }, IsView } = this.props;
        ...
        return (
            <div>
                <SmProTable
                    ...
                    onReset={() => {
                        dispatch({
                            type: 'pdcompletedetail/setTableStatus',
                            payload: {},
                        })
                    }}
                    onLoad={() => {
                ...
                <DetailForm
                    ...
                    onSubmit={async (values, calback) => {
                        ...
                        dispatch({
                            type: 'pdcompletedetail/batchSaveData',
                            payload: values,
                        }).then((result) => {
