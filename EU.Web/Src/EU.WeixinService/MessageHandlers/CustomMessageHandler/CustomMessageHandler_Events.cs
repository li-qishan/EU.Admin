...
using EU.WeixinService.Download;
using System;
...
namespace EU.WeixinService.CustomMessageHandler
{
    /// <summary>
    /// 自定义MessageHandler
    /// </summary>
                ...
                case "GetNewMediaId"://获取新的MediaId
                    {
                        ...
                        try
                        {
                            var result = Senparc.Weixin.MP.AdvancedAPIs.MediaApi.UploadForeverMedia(appId, ServerUtility.ContentRootMapPath("~/Images/logo.jpg"), UploadForeverMediaType.image);
                            //var result = Senparc.Weixin.MP.AdvancedAPIs.MediaApi.UploadForeverMedia(appId, ServerUtility.ContentRootMapPath("~/Images/logo.jpg"), Senparc.Weixin.MP.UploadForeverMediaType.image);
