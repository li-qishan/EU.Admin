...
using EU.WeixinService.OpenTicket;
using EU.WeixinService.Utilities;
#else
using EU.WeixinService.CustomMessageHandler;
using EU.WeixinService.OpenTicket;
using EU.WeixinService.Utilities;
...
namespace EU.WeixinService.MessageHandlers.OpenMessageHandler
{
    /// <summary>
    /// 开放平台全网发布之前需要做的验证
    /// </summary>
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            if (requestMessage.Content.StartsWith("QUERY_AUTH_CODE:"))
            {
                ...
                try
                {
                    ...
                    var sendResult = Senparc.Weixin.WxOpen.AdvancedAPIs.CustomApi.SendText(oauthResult.authorization_info.authorizer_access_token,
