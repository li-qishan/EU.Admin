...
namespace EU.Model
{
    ...
    public class ApInvoiceOrder : Base.PersistPoco
    {
        ...
        /// 含税金额
        /// </summary>
        [Display(Name = "TaxIncludedAmount"), Column(TypeName = "decimal(20,6)")]
        public decimal? TaxIncludedAmount { get; set; } = 0;

        /// <summary>
        /// 发票金额
        /// </summary>
        [Display(Name = "InvoiceAmount"), Column(TypeName = "decimal(20,6)")]
        public decimal? InvoiceAmount { get; set; } = 0;

        /// <summary>
        /// 发票差额
        /// </summary>
        [Display(Name = "InvoiceDiffAmount"), Column(TypeName = "decimal(20,6)")]
