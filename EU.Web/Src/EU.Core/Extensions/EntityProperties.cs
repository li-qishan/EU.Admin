...
namespace EU.Core.Extensions
{
    ...
    {
        public static bool ContainColumn(Type type, string columnName)
        {
            bool result = false;
            PropertyInfo info = type.GetProperties().Where(x => x.Name.ToLower() == columnName.ToLower()).FirstOrDefault();
            if (info != null)
            {
                result = true;
            }
                ...
                foreach (var member in members)
                {
                    switch (member)
                    {
                        case PropertyInfo property:
                            ...
                            object boxedB = source;
                            property.SetValue(boxedB, value, null);
                            source = (T)boxedB;
        ...
        /// </param>
        //public static SaveModel SetDefaultVal(this SaveModel saveDataModel, TableDefaultColumns defaultColumns, UserInfo userInfo = null, string programName = null)
        //{
        //    SetDefaultVal(saveDataModel.MainData, defaultColumns, userInfo, programName);
        ...
        //{
        //    return SetDefaultVal(dic, defaultColumns, userInfo, null);
        //}
        //private static Dictionary<string, object> SetDefaultVal(this Dictionary<string, object> dic, TableDefaultColumns defaultColumns, UserInfo userInfo = null, string programName = null)
        //{
        //    userInfo = userInfo ?? ManageUser.UserContext.Current.UserInfo;
        ...
        //    {
        //        dic[valuePair.Key ?? defaultColumns.UserIdField] =  userInfo.UserName;
        //    }
        ...
        //    {
        //        dic[valuePair.Key ?? defaultColumns.UserNameField] = programName;// userInfo.UserTrueName;
        //    }
        ...
        //{
        //    return SetDefaultVal(dic, AppSetting.CreateMember, null, null);
        //}
        //public static Dictionary<string, object> SetModifyDefaultVal(this Dictionary<string, object> dic)
        //{
        //    return SetDefaultVal(dic, AppSetting.ModifyMember, null, null);
        //}
    }
