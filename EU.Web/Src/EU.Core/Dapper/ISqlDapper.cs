...
namespace EU.Core.Dapper
{
    public interface ISqlDapper
    {
        ...
        Task<List<T>> QueryListAsync<T>(string cmd, object param = null, IDbTransaction transaction = null, CommandType? commandType = null, int? commandTimeout = null) where T : class;
        T QueryFirst<T>(string cmd, object param = null, CommandType? commandType = null, bool beginTransaction = false) where T : class;
        Task<T> QueryFirstAsync<T>(string cmd, object param = null, CommandType? commandType = null, IDbTransaction transaction = null, int? commandTimeout = null) where T : class;
