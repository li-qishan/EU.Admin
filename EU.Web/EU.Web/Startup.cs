...
public class Startup
{
    ...
    public void ConfigureContainer(ContainerBuilder builder)
    {
        ...
        //builder.RegisterGeneric(typeof(UnitOfWorkManage<>)).As(typeof(IUnitOfWorkManage)).InstancePerDependency();
        //builder.RegisterGeneric(typeof(UnitOfWorkManage<>)).As<IUnitOfWorkManage>().InstancePerDependency();//注册服务
