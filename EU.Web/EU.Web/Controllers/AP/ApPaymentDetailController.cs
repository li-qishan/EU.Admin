...
namespace EU.Web.Controllers.AP
{
    ...
    public class ApPaymentDetailController : BaseController1<ApPaymentDetail>
    {
        /// <summary>
        /// 采购付款单明细
        /// </summary>
        ...
        public ApPaymentDetailController(DataContext _context, IBaseCRUDVM<ApPaymentDetail> BaseCrud) : base(_context, BaseCrud)
        {
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult Add(ApPaymentDetail Model)
        {
            ...
            try
            {
                ...
                Model.SerialNumber = Utility.GenerateContinuousSequence("ApPaymentDetail", "SerialNumber", "OrderId", Model.OrderId.ToString());
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult BatchAdd(List<ApPaymentDetail> data)
        {
        ...
        public override IActionResult Delete(Guid Id)
        {
            ...
            try
            {
                ...
                ApPaymentDetail Model = _context.ApPaymentDetail.Where(x => x.ID == Id).SingleOrDefault();
                if (Model != null)
