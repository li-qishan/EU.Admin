    ...
    public class ArInitAccountOrderController : BaseController1<ArInitAccountOrder>
    {
        ...
        public override async Task<IActionResult> GetById(Guid Id)
        {
            ...
            try
            {
                ...
                Supplier supplier = await _context.BdSupplier.AsNoTracking().Where(O => O.ID == order.SupplierId).FirstOrDefaultAsync();
                if (supplier != null)
        ...
        public IActionResult AuditOrder(dynamic modelModify)
        {
            ...
            try
            {
                ...
                #region 导入订单操作历史
                DBHelper.RecordOperateLog(UserId.ToString(), "PD_ORDER_MNG", "ArInitAccountOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
                #endregion
