...
namespace EU.Web.Controllers.AR
{
    ...
    public class ArInvoiceDetailController : BaseController1<ArInvoiceDetail>
    {
        ...
        public ArInvoiceDetailController(DataContext _context, IBaseCRUDVM<ArInvoiceDetail> BaseCrud) : base(_context, BaseCrud)
        {
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult Add(ArInvoiceDetail Model)
        {
            ...
            try
            {
                ...
                Model.SerialNumber = Utility.GenerateContinuousSequence("ArInvoiceDetail", "SerialNumber", "OrderId", Model.OrderId.ToString());
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult BatchAdd(List<ArInvoiceDetail> data)
        {
        ...
        public override IActionResult Delete(Guid Id)
        {
            ...
            try
            {
                ...
                ArInvoiceDetail Model = _context.ArInvoiceDetail.Where(x => x.ID == Id).SingleOrDefault();
                if (Model != null)
