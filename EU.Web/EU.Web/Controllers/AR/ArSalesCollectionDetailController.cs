...
namespace EU.Web.Controllers.AR
{
    ...
    public class ArSalesCollectionDetailController : BaseController1<ArSalesCollectionDetail>
    {
        ...
        public ArSalesCollectionDetailController(DataContext _context, IBaseCRUDVM<ArSalesCollectionDetail> BaseCrud) : base(_context, BaseCrud)
        {
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult Add(ArSalesCollectionDetail Model)
        {
            ...
            try
            {
                ...
                Model.SerialNumber = Utility.GenerateContinuousSequence("ArSalesCollectionDetail", "SerialNumber", "OrderId", Model.OrderId.ToString());
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult BatchAdd(List<ArSalesCollectionDetail> data)
        {
        ...
        private void BatchUpdateSerialNumber(string orderId)
        {
            string sql = @"UPDATE A
                        ...
                        FROM ArSalesCollectionDetail A
                             JOIN
        ...
        public override IActionResult Delete(Guid Id)
        {
            ...
            try
            {
                ...
                ArSalesCollectionDetail Model = _context.ArSalesCollectionDetail.Where(x => x.ID == Id).SingleOrDefault();
                if (Model != null)
