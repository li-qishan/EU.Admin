...
namespace EU.Web.Controllers.IV
{
    ...
    public class IvOtherInController : BaseController<IvOtherIn>
    {
        ...
        public IActionResult AuditOrder(dynamic modelModify)
        {
            ...
            try
            {
                ...
                #region 导入订单操作历史
                DBHelper.RecordOperateLog(User.Identity.Name, "IV_STOCK_OTHER_IN_MNG", "IvOtherIn", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
                #endregion
        ...
        public IActionResult ConfirmIn(Guid Id)
        {
            ...
            try
            {
                ...
                #region 导入订单操作历史
                DBHelper.RecordOperateLog(User.Identity.Name, "IV_STOCK_OTHER_IN_MNG", "IvOtherIn", Id.ToString(), OperateType.Update, "Audit", "用户进行确认其他入库");
                #endregion
