...
namespace EU.Web.Controllers.PD
{
    ...
    public class PdReturnDetailController : BaseController1<PdReturnDetail>
    {
        ...
        public PdReturnDetailController(DataContext _context, IBaseCRUDVM<PdReturnDetail> BaseCrud) : base(_context, BaseCrud)
        {
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult Add(PdReturnDetail Model)
        {
            ...
            try
            {
                ...
                Model.SerialNumber = Utility.GenerateContinuousSequence("PdReturnDetail", "SerialNumber", "OrderId", Model.OrderId.ToString());
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult BatchAdd(List<PdReturnDetail> data)
        {
        ...
        public override IActionResult Delete(Guid Id)
        {
            ...
            try
            {
                ...
                PdReturnDetail Model = _context.PdReturnDetail.Where(x => x.ID == Id).SingleOrDefault();
                if (Model != null)
