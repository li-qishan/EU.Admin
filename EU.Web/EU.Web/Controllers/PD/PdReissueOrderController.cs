    ...
    public class PdReissueOrderController : BaseController<PdReissueOrder>
    {
        ...
        public IActionResult AuditOrder(dynamic modelModify)
        {
            ...
            try
            {
                ...
                #region 导入订单操作历史
                DBHelper.RecordOperateLog(User.Identity.Name, "PD_REISSUE_ORDER_MNG", "PdReissueOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
                #endregion
        ...
        public IActionResult ConfirmReissue(Guid Id)
        {
            ...
            try
            {
                ...
                #region 导入订单操作历史
                DBHelper.RecordOperateLog(User.Identity.Name, "PD_REISSUE_ORDER_MNG", "PdReissueOrder ", Id.ToString(), OperateType.Update, "CompleteOut", "修改订单审核状态为：CompleteOut");
                #endregion
