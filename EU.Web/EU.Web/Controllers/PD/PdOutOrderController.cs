...
namespace EU.Web.Controllers.PD
{
    ...
    public class PdOutOrderController : BaseController<PdOutOrder>
    {
        ...
        public PdOutOrderController(DataContext _context, IBaseCRUDVM<PdOutOrder> BaseCrud) : base(_context, BaseCrud)
        {
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult Add(PdOutOrder Model)
        {
            ...
            try
            {
                ...
                Model.OrderNo = Utility.GenerateContinuousSequence("PdOutOrderNo");
        ...
        public IActionResult AuditOrder(dynamic modelModify)
        {
            ...
            try
            {
                ...
                DbUpdate du = new DbUpdate("PdOutOrder");
                du.Set("AuditStatus", auditStatus);
                du.Where("ID", "=", orderId);
                DBHelper.Instance.ExecuteScalar(du.GetSql());

                #region 导入订单操作历史
                DBHelper.RecordOperateLog(User.Identity.Name, "PO_ARRIVAL_ORDER_MNG", "PdOutOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
                #endregion
        ...
        public override IActionResult Delete(Guid Id)
        {
            ...
            try
            {
                var Order = _context.PdOutOrder.Where(x => x.ID == Id).SingleOrDefault();
        ...
        public virtual IActionResult GetSourceList(string paramData)
        {
            ...
            string defaultSql = @"SELECT A.ID,
                                       ...
                                       NULL BatchNo,
                                       D.Formula,
                                       A.MaterialId ShouldMaterialId,
                                       E.MaterialNo ShouldMaterialNo,
                                       E.MaterialName ShouldMaterialName,
                                       E.Specifications ShouldSpecifications,
                                       E.TextureName ShouldTextureName,
                                       E.UnitName ShouldUnitName
                                FROM PdOrderMaterial A
                                     ...
                                     LEFT JOIN BdBOMMaterial_V D ON B.MaterialId = D.MaterialId
            ...
            obj.data = DBHelper.Instance.QueryList<OutSourceList>(sql);
        ...
        public IActionResult ConfirmOut(Guid Id)
        {
            ...
            try
            {
                ...
                Utility.IsNullOrEmpty(Id, "材料出库单ID不能为空！");
                ...
                #region 导入订单操作历史
                DBHelper.RecordOperateLog(User.Identity.Name, "PD_OUT_ORDER_MNG", "PdOutOrder ", Id.ToString(), OperateType.Update, "CompleteOut", "修改订单审核状态为：CompleteOut");
                #endregion
