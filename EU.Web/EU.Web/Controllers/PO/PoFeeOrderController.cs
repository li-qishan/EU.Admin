...
namespace EU.Web.Controllers.PO
{
    ...
    public class PoFeeOrderController : BaseController1<PoFeeOrder>
    {
        /// <summary>
        /// 采购费用单
        /// </summary>
        ...
        public PoFeeOrderController(DataContext _context, IBaseCRUDVM<PoFeeOrder> BaseCrud) : base(_context, BaseCrud)
        {
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public override IActionResult Add(PoFeeOrder Model)
        {
            ...
            try
            {
                ...
                //#endregion 
                Model.OrderNo = Utility.GenerateContinuousSequence("PoFeeOrderNo");
        ...
        public override async Task<IActionResult> GetById(Guid Id)
        {
            ...
            try
            {
                PoFeeOrder order = _BaseCrud.GetById(Id);
        ...
        public IActionResult AuditOrder(dynamic modelModify)
        {
            ...
            try
            {
                ...
                DbUpdate du = new DbUpdate("PoFeeOrder");
                du.Set("AuditStatus", auditStatus);
                du.Where("ID", "=", orderId);
                DBHelper.Instance.ExecuteScalar(du.GetSql());

                #region 导入订单操作历史
                DBHelper.RecordOperateLog(User.Identity.Name, "PO_ORDER_MNG", "PoFeeOrder", orderId, OperateType.Update, "Audit", "修改订单审核状态为：" + auditStatus);
                #endregion
        ...
        public override IActionResult Delete(Guid Id)
        {
            ...
            try
            {
                var Order = _context.PoFeeOrder.Where(x => x.ID == Id).SingleOrDefault();
        ...
        public virtual IActionResult GetFeeSourceList(string paramData, string masterId, string Source)
        {
            ...
            try
            {
                ...
                //var PoFeeOrder = _context.PoFeeOrder.Where(x => x.ID == Guid.Parse(masterId))
                ...
                Guid? supplierId = PoFeeOrder.SupplierId;
                decimal? taxRate = PoFeeOrder.TaxRate;
